package com.gbjm.core.architecture.presentation
...
abstract class BaseFragment<VM: ViewModel, DB : ViewDataBinding> : DaggerFragment() {
     ...
     * The data binding
     */
    protected val binding: DB get() = realBinding ?: throw IllegalStateException("Trying to access the binding outside of the view lifecycle.")
